...
| skill | いつ invoke するか |
|---|---|
| [`kozutsumi-issues`](.claude/skills/kozutsumi-issues/SKILL.md) | 次の issue を選ぶ / 起票 / close / 棚卸し / Phase 計画 / ADR 起票 |

skill を invoke せずに issue 運用や Phase 計画を行わないこと。運用の一貫性は skill の内容で担保している。
